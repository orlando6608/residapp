...
public static class ApplicationResultRunner
{
    private static readonly Regex AccessDeniedPattern =
        new("(?:RESIDENT_CREATE|BASELINE_SIGN|CLINICAL_DETAIL_READ)_NOT_AUTHORIZED", RegexOptions.Compiled);
    ...
    private static readonly Regex InvalidInputPattern = new(
        ...
        "DAILY_CHANGE_AREA_DUPLICATED|DAILY_CHANGE_AREA_OPTION_INVALID|DAILY_CHANGE_PRIORITY_DOCUMENTATION_REQUIRED)$", RegexOptions.Compiled);
