# Boceto de pantallas - Administración

**Versión:** 0.1
**Fecha:** 2026-09-12
**Estado:** Borrador
**Fuente canónica:** Markdown
**Deriva de:** `docs/legado-cloudflare/docs/product/wireframes/2026-09-06-wireframe-funcional-administracion-v0.3.md`
**Referencias:** `docs/historias-usuarios/administracion.md` y `docs/producto/alcance.md`.

## 1. Alcance

Adaptación del wireframe legado de Administración a la especificación vigente. El contenido funcional ya era coherente con `docs/historias-usuarios/administracion.md`. Se actualizan las referencias normativas (de PRD y matriz de permisos legados a las historias de usuario y al alcance vigentes).
...
| --- | --- | --- |
| Referencias normativas | PRD y matriz de permisos legados | `docs/historias-usuarios/administracion.md` y `docs/producto/alcance.md` |
