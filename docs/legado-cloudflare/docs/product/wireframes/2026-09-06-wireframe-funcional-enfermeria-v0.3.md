...
**Sustituye:** Wireframe funcional Enfermería v0.2  
**Referencias normativas:** PRD v0.5 (`AUTH`, `RES`, `BAS`, `ENF`, `DER`, `FAM`, `HIS`, `COR`, `AUD`) y matriz de permisos v0.2.1.
...
## 8. Cambios de v0.2 a v0.3

- ENF-19 incorpora el catálogo cerrado de sexo documentado y prohíbe inferencia o texto libre.
- ENF-20 diferencia `NINGUNA` de `NO_DOCUMENTADO`, restringe `NO_APLICA` a alimentación exclusivamente enteral y exige descripción para `OTRO/OTRA`.
- No se añaden permisos ni se habilitan los flujos diferidos `D1-P04`–`D1-P06`.
