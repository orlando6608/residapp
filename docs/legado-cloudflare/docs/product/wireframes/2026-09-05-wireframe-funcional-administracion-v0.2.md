...
**Sustituye:** Wireframe funcional Administración v0.1  
...
- **Campos:** identidad mínima y fecha de alta; ubicación inicial coherente con la estructura configurada.
- **Resultado:** identidad creada y basal pendiente.
- **Reglas:** idempotencia; Enfermería solo puede usar este flujo con permiso excepcional; Medicina no.
