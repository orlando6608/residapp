...
**Sustituye:** Wireframe funcional Medicina v0.1  
...
- **Reglas:** un borrador activo por residente; exactamente nueve áreas; `BARTHEL_COMUN_V0_1` de diez ítems con total automático/100; fuente y fecha comunes; sin CFS/Pfeiffer; basal firmado inmutable; rectificación mediante nueva versión vinculada y actualmente bloqueada hasta definir actor/alcance.
