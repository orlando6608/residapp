# Wireframe funcional - Dirección / Coordinación Clínica

**Versión:** 0.1  
**Fecha de canonicalización:** 2026-09-05  
**Estado:** Cerrado; coherencia comprobada para línea base  
**Fuente canónica:** Markdown  
**Equivale funcionalmente a:** Wireframe funcional Dirección / Coordinación Clínica v0.1  
**Referencias:** PRD v0.4 y matriz de permisos v0.2.

## 1. Alcance

Conversión a Markdown sin rediseño. Se conserva el perfil de supervisión separado de Administración y de los perfiles asistenciales. Se precisan acceso basal, auditoría previa y cambio explícito de perfil para actuar clínicamente.
...
- Puede mostrar nueve áreas, Barthel común y relaciones entre versiones; nunca CFS.
...
No se detecta rediseño necesario respecto al PDF v0.1. La canonicalización precisa los controles ya exigidos por PRD v0.4 y permisos v0.2.
