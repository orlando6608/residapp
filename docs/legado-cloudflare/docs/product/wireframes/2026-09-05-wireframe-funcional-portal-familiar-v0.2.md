# Wireframe funcional - Portal Familiar

**Versión:** 0.2  
**Fecha:** 2026-09-05  
**Estado:** Candidato a línea base funcional  
**Fuente canónica:** Markdown  
**Sustituye:** Wireframe funcional Portal Familiar v0.1  
**Referencias:** PRD v0.4 y matriz de permisos v0.2.

## 1. Alcance de la revisión

Se conservan `FAM-01` a `FAM-18`. El cambio material es que `FAM-13` y `FAM-14` representan las dos modalidades de citas configurables por centro, mostradas de forma excluyente. También se explicitan los límites clínicos y la inmutabilidad/corrección de publicaciones.
...
- No accede a observaciones, valoraciones, constantes, basal, Barthel, GDS, indicaciones, seguimientos, derivaciones, Historial ni línea temporal interna.
- CFS queda retirada incluso como referencia de contenido no visible.
...
| --- | --- |
| FAM-13 | Flujo único adaptativo: reserva directa o solicitud previa |
| FAM-14 | Seguimiento específico por modalidad, sin chat |
| Contenido | Límites clínicos consolidados; CFS retirada |
| Publicaciones | Original inmutable, correctora vinculada y retirada excepcional auditada |
