...
**Versión:** 0.1  
**Fecha:** 2026-09-05  
**Estado:** Candidata a línea base funcional  
...
2. PRD Plataforma de contacto con familias v0.4 consolidado.
3. Matriz de permisos de seis perfiles v0.2.
4. Wireframes canónicos: Auxiliar v0.2, Enfermería v0.2, Medicina v0.2, Portal Familiar v0.2, Administración v0.2 y Dirección/Coordinación Clínica v0.1.
...
| Requisito | Permiso/condición | Pantalla | Entidad lógica | Prueba trazable |
| --- | --- | --- | --- | --- |
| `RES-01` | `BASE` según perfil/ámbito | ADM-03/04; ENF-17/18; MED-19/20 | `Resident` | `TR-RES-01`: edad se calcula y los ID son opacos, no secuenciales ni autorizantes. |
...
| `BAS-16` | Borrador propio + permiso basal | ENF-20; MED-21 | `MobilityBaselineAnswer` | `TR-BAS-16`: modo, ayuda técnica, humana y transferencias son distintos; no duplica ayuda técnica. |
| `BAS-17` | Borrador propio + permiso basal | ENF-20; MED-21 | `FeedingBaselineAnswer` | `TR-BAS-17`: texturas y espesantes admiten exactamente las opciones aprobadas, incluido no documentado. |
| `BAS-18` | Borrador propio + permiso basal | ENF-20/23; MED-21 | `BaselineVersion`, `DocumentedSource` | `TR-BAS-18`: fuente/fecha comunes; incompatibles excluyentes; `OTRO` exige descripción aplicable. |
